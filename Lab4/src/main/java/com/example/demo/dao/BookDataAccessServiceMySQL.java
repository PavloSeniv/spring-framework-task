...
//        libraryCRUD.save(lib);
//    }
//
//    @Override
//    public void deleteById(int id) {
//        libraryCRUD.deleteById(id);
//    }
//
//    @Override
//    public void deleteAll() {
//        libraryCRUD.deleteAll();
//    }
//
//    @Override
//    public Library getById(int id) {
//        return libraryCRUD.findById(id).get();
//    }
//
//    @Override
//    public List<Library> getAll() {
//        List<Library> list = new ArrayList<>();
//        var iter = libraryCRUD.findAll().iterator();
//        while (iter.hasNext()) list.add(iter.next());
//        return list;
//    }
//
//    @Override
//    public void modifyById(int id, Library lib) {
//        lib.setId(id);
//        libraryCRUD.save(lib);
//    }
//
...
//        return libraryCRUD.findByAuthor(author).get();
//    }
//
//    @Override
//    public List<Library> getByPublisher(String publisher) {
//        return libraryCRUD.findByPublisher(publisher).get();
//    }
//    */
//}
